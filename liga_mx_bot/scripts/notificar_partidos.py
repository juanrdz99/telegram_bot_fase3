...
python scripts/notificar_partidos.py --tipo semana   # Notifica partidos de toda la semana
python scripts/notificar_partidos.py --tipo finde    # Notifica partidos del fin de semana
python scripts/notificar_partidos.py --tipo jornada  # Notifica partidos de la jornada actual
"""
import asyncio
import logging
import datetime
